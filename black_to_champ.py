...
def main():
    # 配置
    PRIVATE_KEY = "XXXXX"  # 请替换为实际私钥
    ROUTER_ADDRESS = "0x1B6814F3227a246F62bC47b148b3d288Dbc85715" 

    # 交易参数
    amount_in = 0x4563918244f40000  # 5e18 (5 tokens)
    amount_out_min = 0  # ~4.35 tokens
    to_address = Web3.to_checksum_address("xxxxxx") #替换为自己的钱包地址
    deadline = int((datetime.now() + timedelta(minutes=30)).timestamp())  # 动态截止时间：当前时间 + 30 分钟
    routes = [{
        "pair": Web3.to_checksum_address("0x30b9e2f4f7997d9cae48e3106e5737ceef90fa76"),
        "from": Web3.to_checksum_address("0xa981371a120b0e1bbdcd0abab1ed509c1084fe5f"),
        "to": Web3.to_checksum_address("0x0a7f642b4810ca584d0cc3932522c824b08459b6"),
        "stable": False,
        "concentrated": False,
        "receiver": Web3.to_checksum_address("0x4e90a36b45879f5bae71b57ad525e817afa54890")
    }]
